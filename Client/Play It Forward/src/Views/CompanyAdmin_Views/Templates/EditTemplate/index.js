...
>>>>>>> 26ff065df83033206e95f6cb27d8d3910f9893e2
        ...
        <div className='CreateTemplate-Body token' style={{ overflow: 'hidden' }}>
          <div className='CreateTemplate-Body-Left'>
            <div className='CreateTemplate-Body-Top'>
              <SoftTypography variant="h6" component="div" style={{ marginTop: "17px" }}>
                Template Preview
              </SoftTypography>
            </div>
              ...
              <div className='TemplatePreview' style={{ //zoom out 50% 
                ...
                <div className='Template' style={{ height: '1000px' }}>
                  ...
                  <div className='PngTemplate' style={{
                    ...
                    <div className='TokenType' style={{
                      zIndex: 3, position: "relative", bottom: "1800px",
          ...
          <div className='CreateTemplate-Body-Right'>
            ...
            <div className='CreateTemplate-Body-Right-Bottom'>
              <div className='TemplateConfigurationName' style={{ display: "flex" }}>
                <div style={{ width: "60%" }}>
                  <span>Name: </span>
                  <SoftInput type="text" value={Name} onChange={(e) => { setName(e.target.value) }} />
                </div>
                <div style={{ width: "35%", marginLeft: "5%" }}>
                  <span>Amount: </span>
                  <SoftInput type="number" value={Amount} onChange={(e) => { setAmount(e.target.value) }} placeholder="$" />
                </div>
              </div>
              <div className='TemplateConfigurationDescription'>
                <span>Description: </span>
                <SoftInput type="text" value={Description} onChange={(e) => { setDescription(e.target.value) }} />
              </div>
              <div className='TemplateConfigurationColors'>
                ...
                <div className='TemplateConfigurationColor' style={{ marginTop: "20px" }}>
                ...
                <div className='col-4 TemplateConfigurationColor' style={{
